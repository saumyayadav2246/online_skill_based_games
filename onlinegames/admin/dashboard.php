...
<head>
    ...
    <title>Admin Dashboard - Brain League</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom shadow-sm sticky-top py-2">
        <div class="container-fluid px-3 px-md-4">
            ...
            <a class="navbar-brand fw-bold fs-5 me-auto d-flex align-items-center text-decoration-none" href="admin_dashboard.php">
            ...
            <div class="col-lg-9 col-xl-10">
                ...
                <div class="card shadow-sm border-0 mb-4">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <p class="text-muted">You are logged in as an Administrator. Use the side menu to manage users and education content.</p>
                        <div class="d-flex flex-wrap gap-2 mt-4">
                            <a href="users_manage.php" class="btn btn-primary px-4 py-2 rounded-pill disabled">Manage Users</a>
                            <a href="skills_manage.php" class="btn btn-outline-dark px-4 py-2 rounded-pill disabled">Edit Skills</a>
                        </div>
                    </div>
                </div>
            </div> 
